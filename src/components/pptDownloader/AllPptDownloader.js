...
const AllPptDownloader = () => {
  ...
  const adminQuestionsReducer = useSelector(
    (state) => state.getAdminQuestionByModelIdReducer
  );
  ...
  const generateFirstSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        ...
        adminQuestionsReducer?.question?.data[0]
      ) {
        const chartData = [];
  ...
  const generateThirdSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[2]
      ) {
  ...
  const generateFourthSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[3]
      ) {
  ...
  const generateFifthSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[4]
      ) {
  ...
  const generateSixthSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[5]
      ) {
  ...
  const generateSeventhSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[6]
      ) {
  ...
  const generateEightSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[7]
      ) {
  ...
  const generateNingthSlide = (slide, pptx) => {
    return new Promise((resolve) => {
      if (
        adminQuestionsReducer?.question?.data &&
        adminQuestionsReducer?.question?.data[8]
      ) {
        // const chart9Reducer = useSelector((state) => state.chart9Reducer);
