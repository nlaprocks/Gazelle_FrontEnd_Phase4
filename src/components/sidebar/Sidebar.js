...
const Sidebar = ({ sidebarState }) => {
  ...
  return (
    <>
      <div className={`left_sidebar bg-[#0d0e23] ${sidebarState ? "sidebarCollapse" : ""}`} data-position="right" id="leftSideBar">
        <div>
          <ul className="nav">
            {adminObserver ? (
              <>
                <li className={path.includes("/admin/dashboard") ? "active" : ""}>
                  <Link to="/admin/dashboard">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Dashboard</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/user-management") ? "active" : ""}>
                  <Link to="/admin/user-management">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>User Management</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/project-management") ? "active" : ""}>
                  <Link to="/admin/project-management">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Project Management</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/design-studio") ? "active" : ""}>
                  <Link to="/admin/design-studio">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Design Studio</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/insights-management") ? "active" : ""}>
                  <Link to="/admin/insights-management">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Insights Management</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/products&Categories") ? "active" : ""}>
                  <Link to="/admin/products&Categories">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Products and Category Management</span>
                  </Link>
                </li>
                <li className={path.includes("/admin/scheduling-management") ? "active" : ""}>
                  <Link to="/admin/scheduling-management">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Scheduling Management</span>
                  </Link>
                </li>
              </>
            ) : (
              <>
                <li className={activeDash === true ? "active" : ""}>
                  <Link to="/dashboard">
                    ...
                    <span className={sidebarState ? "sidebarCollapse" : ""}>Home</span>
                  </Link>
                </li>
