...
export default function Financials({ promotedPrice, units, increamentalUnits, basePrice, isPriceSimulationLoading }) {
    ...
    setFinancialsChartData([
      {
        ...
        data: {
          ...
          datasets: [
            {
              name: "Gross Revenue",
              data: [grossRevenue !== null ? parseFloat(grossRevenue).toFixed(2) : null, null, null, null, null],
              type: 'column',
              yAxisID: 'left-y-axis',
            },
            {
              name: "Incremental Revenue",
              data: [null, increamentalRevenue !== null ? parseFloat(increamentalRevenue).toFixed(2) : null, null, null, null],
              type: 'column',
              yAxisID: 'left-y-axis',
            },
            {
              name: "Incremental Profit",
              data: [null, null, increamentalProfit !== null ? parseFloat(increamentalProfit).toFixed(2) : null, null, null],
              type: 'column',
              yAxisID: 'left-y-axis',
            },
            {
              name: "Sales ROI",
              data: [null, null, null, percentageROI !== null ? parseFloat(percentageROI).toFixed(2) : null, null],
              type: 'column',
              yAxisID: 'right-y-axis',
            },
            {
              name: "Retail Promo Margin %",
              data: [null, null, null, null, retailerPromoMargin !== null ? parseFloat(retailerPromoMargin).toFixed(2) : null],
              type: 'column',
              yAxisID: 'right-y-axis',
            },
          ],
  ...
  formatter: (value, { seriesIndex, dataPointIndex, w }) => {
    ...
    return value !== null && value !== undefined ? parseFloat(value).toFixed(2) + " %" : value;
  }
},
